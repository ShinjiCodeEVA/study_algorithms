...
VALUES ('bruteforce', 'The brute force approach to finding the maximum product subarray involves checking all possible subarrays and calculating their products to find the maximum product.',
        '{"steps": [ "Initialize a variable max_product to store the maximum product, initially set to the minimum possible value.",
                    ...
                    "Return max_product as the maximum product of a subarray within the given array."]}', null,
                    @problem_id);
...
VALUES ('efficient', 'To solve this problem, you can utilize the dynamic programming approach. Here’s a general outline of the solution:',
        '{"steps": ["Initialize two variables, max_product and min_product, both set to the first element of the array",
                    ...
                    'https://i0.wp.com/studyalgorithms.com/wp-content/uploads/2023/06/Screen-Shot-2023-06-30-at-6.47.24-PM.png?resize=768%2C257&ssl=1', @problem_id); 
                    
INSERT INTO decode (replit, problem_id)
VALUES ('https://replit.com/@HarviePurgatori/RadiantCelebratedAccess?embed=true', @problem_id);

INSERT INTO testcase (input, output, explanation, problem_id)
VALUES ('nums = [ 2 , 3 , -2 , 4 ]', '6', '[ 2 , 3 ] has the largest product 6.', @problem_id),
       ('nums = [ 2 , 3 , -2 , -5 , 6 , -1 , 4 ]', '360', '[ 2 , 3 , -2 , -5 , 6 ] has the largest product 360.', @problem_id);
