...
-- INSERT 
INSERT INTO efficient (heading, steps, summary, image)
VALUES ("To solve this problem, you can utilize the dynamic programming approach. Here’s a general outline of the solution",
		"Initialize two variables, max_product and min_product, both set to the first element of the array.
				...
				"https://i0.wp.com/studyalgorithms.com/wp-content/uploads/2023/06/Screen-Shot-2023-06-30-at-6.47.24-PM.png?resize=768%2C257&ssl=1"
        );
...
SET @bruteforceId = LAST_INSERT_ID();

INSERT INTO blogpost (title, tags, readTime, description, solutionExplanation, bruteForceId, efficientId)
VALUES ("Maximum Product Subarray Solution", 
 		"array", 
         10,
         "In this blog post, we'll explore the \"Maximum Product Subarray problem,\" where our task is to find the contigous subarray within an array that yields the maximum product. We'll discuss the problem statement in detail and explore two approaches: the brute force solution and an optimized solution using dynamic programming techniques",
...
-- testcase
 ...
 INSERT INTO testcase (blogPostId, input, output, explanation) 
 VALUES (2, 
 		"nums = [ 2 , 3 , -2 , 4 ]",
 		"output: 6",
